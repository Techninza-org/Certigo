...
class HrController extends Controller
{
    ...
    public function viewOfferLetterPdf(Request $request){
        ...
        $parseDate = Carbon::parse($letter->confirmation);
        $startingDate = Carbon::parse($letter->starting_date);
        $createdDate = Carbon::parse($letter->created_at);


        $letter->confirmDate = $parseDate->format("d.m.Y");
        $letter->startingDate = $startingDate->format("d.m.Y");
        $letter->createdDate = $createdDate->format("d/m/Y");
    ...
    public function viewPaySlipPdf(Request $request){
        ...
        // view()->share('slip',$slip);  

        // $pdf = PDF::loadView('pay-slips.pay_slip');   


        // return $pdf->stream('pay_slip.pdf');

      
        return view('pay-slips.pay_slip',['slip'=>$slip]);
    ...
    public function viewappointmentLetterPdf(Request $request){
        ...
        $pdf = PDF::loadView('appointment-letters.appointment-letter-html');   
