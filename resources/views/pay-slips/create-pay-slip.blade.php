                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if (Auth::user()->role == 1 || Auth::user()->role == 3 || Auth::user()->role == 2)
                                            ...
                                            <a class="edit-btn"
                                                href="{{ route('edit.paySlip', ['id' => $one->id]) }}">Edit</a>

                                            <a class="delete-btn" href="#"
                                                onclick="return confirmAndSubmit('{{ route('delete.paySlip') }}', '{{ $one->id }}')">Delete</a>
                                            <form id="payslip-delete{{ $one->id }}"
                                                action="{{ route('delete.paySlip') }}" method="post" class="d-none">
                                                @csrf
...
@if (Auth::user()->role == 5 || Auth::user()->role == 1 || Auth::user()->role == 2 || Auth::user()->role == 3)
                    ...
                    <div class=" d-block align-items-center justify-content-between mb-9">
                        <div class="row justify-content-center w-100">
                            <div class="col-md-12 col-lg-12 col-xxl-12">
                                ...
                                <form method="POST" action="{{ route('post.payslip.page') }}"
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="month" type="text"
                                                ...
                                                value="{{ old('month') }}" required autocomplete="month">
                                            @error('month')
                                            ...
                                            <select id="employee_name"
                                                ...
                                                @foreach ($users as $user)
                                                    <option value="{{ $user['name'] }}"
                                                        data-user-id="{{ $user['id'] }}">{{ $user['name'] }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('employee_name')
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="joined_date" type="date"
                                                ...
                                                name="joined_date" value="{{ old('joined_date') }}" required
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="esi_no" type="text"
                                                class="form-control @error('esi_no') is-invalid @enderror"
                                                name="esi_no" value="{{ old('esi_no') }}" required
                                                autocomplete="esi_no">
                                            @error('esi_no')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
...
@push('js')
    ...
    <script>
        document.getElementById('employee_name').addEventListener('change', function() {
            ...
            const userId = selectedOption.getAttribute('data-user-id'); // Get data-user-id attribute
            document.getElementById('user_id').value = userId; // Update hidden input with the user ID
        });
    </script>
@endpush
