...
@section('content')
    ...
    @endif -->
                    ...
                    <div class=" d-block align-items-center justify-content-between mb-9">
                        <div class="d-flex align-items-center">
                            <a href="{{ route('get.payslip.page') }}" class="btn"><i class="fa-regular fa-circle-left"
                                    style="font-size: x-large;" aria-hidden="true"></i></a>
                            <h3>Edit Pay-slip</h3>
                        </div>
                        <div class="row justify-content-center w-100">
                            ...
                            <div class="col-md-12 col-lg-12 col-xxl-12">
                                ...
                                <form method="POST" action="{{ route('post.edit.paySlip') }}"
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="month" type="number"
                                                ...
                                                value="{{ $slip->month }}" required autocomplete="month">
                                            @error('month')
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="year" type="number"
                                                ...
                                                value="{{ $slip->year }}" required autocomplete="year">
                                            @error('year')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="employee_name" type="text"
                                                ...
                                                name="employee_name" value="{{ $slip->employee_name }}" required
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="employee_number" type="text"
                                                ...
                                                name="employee_number" value="{{ $slip->employee_number }}" required
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="joined_date" type="date"
                                                ...
                                                name="joined_date" value="{{ $slip->joined_date }}" required
                                                autocomplete="joined_date">
                                            @error('joined_date')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="department" type="text"
                                                ...
                                                name="department" value="{{ $slip->department }}" required
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="designation" type="text"
                                                ...
                                                name="designation" value="{{ $slip->designation }}" required
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="bank" type="text"
                                                ...
                                                value="{{ $slip->bank }}" required autocomplete="bank">
                                            @error('bank')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="bank_account" type="number"
                                                ...
                                                name="bank_account" value="{{ $slip->bank_account }}" required
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="uan" type="number"
                                                class="form-control @error('uan') is-invalid @enderror" name="uan"
                                                value="{{ $slip->uan }}" autocomplete="uan">
                                            @error('uan')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="pf_number" type="number"
                                                class="form-control @error('pf_number') is-invalid @enderror"
                                                name="pf_number" value="{{ $slip->pf_number }}"
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="esi_no" type="number"
                                                class="form-control @error('esi_no') is-invalid @enderror" name="esi_no"
                                                value="{{ $slip->esi_value }}" autocomplete="esi_no">
                                            @error('esi_no')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="esi_value" type="numnber"
                                                class="form-control @error('esi_value') is-invalid @enderror"
                                                name="esi_value" value="{{ $slip->esi_value }}" required
    ...
    @enderror
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="twd" type="number"
                                                class="form-control @error('twd') is-invalid @enderror" name="twd"
                                                value="{{ $slip->twd }}" required autocomplete="twd">
                                            @error('twd')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="lpd" type="number"
                                                class="form-control @error('lpd') is-invalid @enderror" name="lpd"
                                                value="{{ $slip->lpd }}" required autocomplete="lpd">
                                            @error('lpd')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="dp" type="number"
                                                ...
                                                value="{{ $slip->dp }}" required autocomplete="dp">
                                            @error('dp')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="gross_salary" type="number"
                                                ...
                                                name="gross_salary" value="{{ $slip->gross_salary }}" required
    ...
    @enderror
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="professional_tax" type="number"
                                                ...
                                                name="professional_tax" value="{{ $slip->professional_tax }}" required
                                                autocomplete="professional_tax">
                                        ...
                                        <div class="mb-4 col-md-4">
                                            ...
                                            <input id="loan_recovery" type="number"
                                                ...
                                                name="loan_recovery" value="{{ $slip->loan_recovery }}" required
    ...
    @enderror
                                    ...
                                    <button type="submit"
                                        class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">Update</button>
