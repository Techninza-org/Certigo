...
@section('content')
                        ...
                        <tbody>
                            @foreach ($letters as $one)
                                <tr>
                                    ...
                                    <td>
                                        <a class="bg-success text-white ps-1 pe-1 pt-2 pb-2"
                                            href="{{ route('edit.appointment.letter.page', ['id' => $one->id]) }}">Edit</a>

                                        <a href="javascript:void(0)" class="view-appointment-btn"
                                            data-id="{{ $one->id }}">View</a>

                                        <a class="bg-danger text-white ps-1 pe-1 pt-2 pb-2"
                                            href="{{ route('view.appointment.pdf', ['id' => $one->id]) }}">Download</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
    ...
    <!-- Modal -->
    <div class="modal fade" id="appointmentLetterModal" tabindex="-1" aria-labelledby="appointmentLetterModalLabel"
        aria-hidden="true">
                        ...
                        <div class="col-md-12 col-lg-12 col-xxl-12">
                            ...
                            <form method="POST" action="{{ route('postappointmentLetter') }}">
                                ...
                                <div class='row'>
                                    ...
                                    <div class="mb-3 col-md-3">
                                        <label for="employee_address" class="form-label">Employee Address <span
                                                class="text-danger">*</span></label>
                                        <input id="employee_address" type="text" class="form-control "
                                    ...
                                    <div class="mb-4 col-md-4">
                                        ...
                                        <input id="ctc-digits" type="number" class="form-control "
                                    ...
                                    <div class="mb-4 col-md-4">
                                        ...
                                        <input id="ctc_words" type="text" class="form-control " name="ctc_words"
                                            value="{{ old('ctc_words') }}" required autocomplete="ctc_words">
                                        @error('ctc_words')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-4 col-md-4">
                                        <label for="probation_periods" class="form-label">Probation period ( in months
                                            )</label>
                                        <input id="probation_periods" type="number" class="form-control "
                                            name="probation_periods" value="{{ old('probation_periods') }}" required
                                            autocomplete="probation_periods">
                                    ...
                                    <div class="mb-4 col-md-4">
                                        ...
                                        <input id="signing_authority" type="text" class="form-control "
                                            name="signing_authority" value="{{ old('signing_authority') }}" required
                                            autocomplete="signing_authority">
                                    ...
                                    <div class="mb-4 col-md-4">
                                        ...
                                        <input id="authority_name" type="text" class="form-control"
                                            name="authority_name" value="{{ old('authority_name') }}" required
                                    ...
                                    <div class="mb-4 col-md-4">
                                        ...
                                        <input id="authority_designation" type="text" class="form-control"
                                            name="authority_designation" value="{{ old('authority_designation') }}"
                                            required autocomplete="authority_designation">
                                    ...
                                    <div class="mb-4 col-md-4">
                                        <label for="date_of_appointment" class="form-label">Date of
                                            Appointment</label>
                                        <input id="date_of_appointment" type="text" class="form-control"
                                            name="date_of_appointment" value="{{ old('date_of_appointment') }}"
                                            required autocomplete="date_of_appointment">
                                    ...
                                    <div class="mb-4 col-md-4">
                                        <label for="reporting_authority" class="form-label">Reporting
                                            Authority</label>
                                        <input id="reporting_authority" type="text" class="form-control"
                                            name="reporting_authority" value="{{ old('reporting_authority') }}"
                                            required autocomplete="reporting_authority">
                                    ...
                                    <div class="mb-4 col-md-4">
                                        ...
                                        <input id="reporting_name" type="text" class="form-control"
                                            name="reporting_name" value="{{ old('reporting_name') }}" required
                                            autocomplete="reporting_name">
                                    ...
                                    <div class="mb-4 col-md-4">
                                        ...
                                        <input id="basic" type="number" class="form-control" name="basic"
                                            value="{{ old('basic') }}" required autocomplete="basic">
                                        @error('basic')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-4 col-md-4">
                                        ...
                                        <input id="hra" type="number" class="form-control" name="hra"
                                            value="{{ old('hra') }}" required autocomplete="hra">
                                        @error('hra')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-4 col-md-4">
                                        ...
                                        <input id="conveyance" type="number" class="form-control" name="conveyance"
                                            value="{{ old('conveyance') }}" required autocomplete="conveyance">
                                        @error('conveyance')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-4 col-md-4">
                                        ...
                                        <input id="special_allowance" type="number" class="form-control"
                                            name="special_allowance" value="{{ old('special_allowance') }}" required
                                            autocomplete="special_allowance">
                                    ...
                                    <div class="mb-4 col-md-4">
                                        ...
                                        <input id="medical" type="number" class="form-control" name="medical"
                                            value="{{ old('medical') }}" required autocomplete="medical">
                                        @error('medical')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-4 col-md-4">
                                        ...
                                        <input id="lta" type="number" class="form-control" name="lta"
                                            value="{{ old('lta') }}" required autocomplete="lta">
                                        @error('lta')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-4 col-md-4">
                                        <label for="monthly_gross_salary" class="form-label">Monthly Gross
                                            Salary</label>
                                        <input id="monthly_gross_salary" type="number" class="form-control"
                                            name="monthly_gross_salary" value="{{ old('monthly_gross_salary') }}"
                                            required autocomplete="monthly_gross_salary">
                                    ...
                                    <div class="mb-4 col-md-4">
                                        <label for="annual_variable_ctc" class="form-label">Annual Variable
                                            CTC</label>
                                        <input id="annual_variable_ctc" type="number" class="form-control"
                                            name="annual_variable_ctc" value="{{ old('annual_variable_ctc') }}"
                                            required autocomplete="annual_variable_ctc">
                                    ...
                                    <div class="mb-4 col-md-4">
                                        ...
                                        <input id="annual_fixed_ctc" type="number" class="form-control"
                                            name="annual_fixed_ctc" value="{{ old('annual_fixed_ctc') }}" required
                                            autocomplete="annual_fixed_ctc">
