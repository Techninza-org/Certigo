...
<head>
    ...
    <title>Signature pad for signature</title>
...
<div class="container">
   ...
   <div class="row">
       ...
       <a href="{{ url('') }}/complete-sample/{{ $training_id }}"><i class="fa-solid fa-arrow-left" id="autoClickButton"></i></a> 
           ...
           <div class="card">
               ...
               <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('sampleby.signature_pad.store') }}">
