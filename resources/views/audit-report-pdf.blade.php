            ...
            <div class=" " style="width:700px;">
                <div class="">
                    ...
                    <div class="mb-2 text-center" >
                        <strong class="" style="text-align: center;margin-top:0px;font-size:10px">{{ $audit->audit_name }} For {{ $client->organisation_name }}</strong>
                    </div>

                    <div class="" >

                      <p style="font-size: 13px;text-decoration:underline;margin-bottom:0px; padding-bottom:0px;margin-top:10px">Audit Details</p>
                    ...
                    <div style="margin-top: 20px;    border: rgb(188, 188, 188) 1px solid;">
                        ...
                        <table style="border-collapse: collapse;width:100%">
                            ...
                            <tr >
                                ...
                                <td style="height: 150px;width:30%">{{ \Auth::user()->title }}. {{ \Auth::user()->name }} (Micro-biologist/ Lab-Representative) <br><p style="font-size: 13px">{{ $todayDate }} {{ $todayTime }}</p></td>
                                <td style="height: 150px;width:20%"></td>
                                <td style="height: 150px;width:30%">{{ $client->title }}. {{ $client->fname }} {{ $client->lname }} ({{ $client->designation }}) <br><p style="font-size: 13px">{{ $todayDate }} {{ $todayTime }}</p></td>
                    ...
                    <div style="text-align: center;margin-top:50px">
                        ...
                        <p style="font-size: 12px;"><span style="font-size: 12px;color:rgb(106, 106, 106)">Email - </span><a href="mailto:admin@certigoqas.com">admin@certigoqas.com</a> <span style="font-size: 12px;color:rgb(106, 106, 106)">Website address -</span> <span style="font-size: 12px;color:rgb(106, 106, 106)"> Contact us @ </span><a href="tel:+918074937006">+91 8074937006</a> </p>
