            ...
            <div class="card w-100">
                ...
                <div class="card-body">
                    ...
                    <div class=" d-block align-items-center justify-content-between mb-9" >
                        ...
                        @if($sample->points__array !== null)

                        <b class="mt-3">Entered Key Points :</b>

                        @foreach($sample->points__array as $key => $point)
                        ...
                        <div class="d-flex justify-content-evenly align-items-center mb-3 mt-3">
                            ...
                            <a href="{{ route('sampleby.sign.view',$sample->id) }}"><i class="fa-solid fa-file-signature"></i> Trainer's Signature here</a>

                            <a href="{{ route('sampleto.sign.view',$sample->id) }}"><i class="fa-solid fa-file-signature"></i> Trainee's Signature here</a>
                        ...
                        <div class="text-center">
                            ...
                            <a class="btn btn-success pt-0 pb-0" href="{{ route('downlaod.sample.pdf') }}" onclick="event.preventDefault(); document.getElementById('completeSample').submit();">

                                Get Report </a>

                             <form id="completeSample" action="{{ route('downlaod.sample.pdf') }}" method="get" class="d-none">
