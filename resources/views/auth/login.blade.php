              ...
              <div class="card-body">
                ...
                <form method="POST" action="{{ route('login') }}">@csrf
                  ...
                  {{-- <div class="d-flex align-items-center justify-content-center">
                    <p class="fs-4 mb-0 fw-bold">New to Certigo QAS?</p>
                ...
                <div class="d-flex justify-content-center">
                  ...
                  {{-- <a class="fw-medium" style="color: #0068ff;text-decoration:none;font-size:14px" href="{{ route('client.login') }}">Login as a Client</a> --}}
              </div>
                </form>
              </div>
            </div>
