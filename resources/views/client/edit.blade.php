        ...
        <div class="col-lg-12 d-flex align-items-strech">
            ...
            <div class="card w-100">
                ...
                <div class="card-body">
                    ...
                    <h5 class="mb-3" style="    text-transform: uppercase;    text-decoration: underline;color:#525252">
                        Update
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-3">
                                    ...
                                    <select class="form-select" name="title" id="">
                                        ...
                                        <option value="Madam" {{ $client->title == 'Madam' ? 'selected' : '' }}>Madam
                                        </option>
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <label class="form-label">Organization Location <span
                                            class="text-danger">*</span></label>

                                    <input type="text" class="form-control" name="organisation_location"
                                        id="organisation_location" value="{{ $client->organisation_location }}" required>
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="email" class="form-control" name="company_emailid"
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="number" class="form-control" name="comp_cont_no"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="email" class="form-control" name="comp_part_email"
                                ...
                                <div class="mb-3 col-md-4" id="director">
                                    ...
                                    <input type="text" class="form-control" name="director"
                                        placeholder="Director's name" value="{{ $client->director }}">
                                ...
                                <div class=" mb-3 col-md-4" id="director_email_mob">
                                    ...
                                    <input type="email" aria-label="Email" class="form-control mb-3"
                                        name="director_email" placeholder="Director's email"
                                        value="{{ $client->director_email }}">
                                ...
                                <div class=" mb-3 col-md-4">
                                    ...
                                    <input type="number" aria-label="Mobile" class="form-control"
                                        name="director_mobile" placeholder="Director's mobile"
                                        value="{{ $client->director_mobile }}">
                                ...
                                <div class="mb-3 col-md-4" id="food_email_mob">
                                    ...
                                    <input type="email" aria-label="Email" class="form-control mb-3" name="food_email"
                                        placeholder="FSTL's email" value="{{ $client->food_email }}">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="number" aria-label="Mobile" class="form-control" name="food_mobile"
                                        placeholder="FSTL's mobile" value="{{ $client->food_mobile }}">
