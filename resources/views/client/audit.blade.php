...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.progress').each(function() {
                ...
                var maxVal = 100; // Assuming the maximum value for 100% progress
                ...
                // Calculate the width percentage and set it for .progress element
                ...
                // Calculate the hue value for background color and set it based on value range
    ...
    {{-- show two more options for industrial report  --}}
    ...
    {{-- <script>
        ...
        const auditing_for = document.getElementById('auditing_for');



        const doc_ref = document.getElementById('doc_ref');
        ...
        const director_email_mob = document.getElementById('director_email_mob');
        ...
        const personal_responsible = document.getElementById('personal_responsible');
        ...
        auditing_for.addEventListener('change', function() {
            ...
            if (this.value == '1') {
                ...
                doc_ref.style.display = 'block';



                personal_responsible.style.display = 'block';
                ...
                director_email_mob.style.display = 'block';



                food_email_mob.style.display = 'block';
                ...
                doc_ref.style.display = 'none';



                personal_responsible.style.display = 'none';
                ...
                director_email_mob.style.display = 'none';



                food_email_mob.style.display = 'none';
